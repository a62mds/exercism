...
def week_of_occurrence(num, monthcal, day):
    return week_of_first_occurrence(monthcal, day) + num
...
week_of = {'1st' : week_of_first_occurrence,
           '2nd' : partial(week_of_occurrence, 1),
           '3rd' : partial(week_of_occurrence, 2),
           '4th' : partial(week_of_occurrence, 3),
           '5th' : partial(week_of_occurrence, 4),
